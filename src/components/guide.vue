<template>
    ...
    <div class="container mb-30">
        <div class="row-cols-1">
            <div class="col flex flex-aro">
                ...
                <button
                    type="button"
                    class="btn btn-sub3">
                    <i class="far fa-sign-in"></i>Sub3 Button
                </button>
                <button
                    type="button"
        ...
        <div class="row-cols-1 mt-20">
            <div class="col flex flex-aro">
                ...
                <button
                    type="button"
                    class="btn-tb btn-sub3">
                    <i class="far fa-sign-in"></i>Table Button Sub3
                </button>
                <button
                    type="button"
    ...
    <div class="tb-container left-th mb-30">
        <table>
            ...
            <tbody>
                <tr>
                    <th>품목<i class="required-icon">*</i></th>
                    <td>
                ...
                <tr>
                    <th>발주량<i class="required-icon">*</i></th>
                    <td>
                        <div class="input-box pull">
                            <input
                                type="text"
                    ...
                    <th>단위<i class="required-icon">*</i></th>
                    <td>
                        <div class="input-box pull">
                            <div
                                class="select-input"
    ...
    <div class="btnbox align-right mb-30">
        <button
            type="button"
            class="btn btn-cancel">
